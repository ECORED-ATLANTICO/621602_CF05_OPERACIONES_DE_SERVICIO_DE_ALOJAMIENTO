  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1 Fundamentos del software hotelero
    ...
    .bloque-texto-g.bloque-texto-g--inverso.bg-color-21.p-3.p-sm-4.p-md-5.mb-5
      ...
      .bloque-texto-g__texto.p-4
        p.mb-0 La transformación digital ha generado importantes cambios en la industria hotelera, permitiendo automatizar procesos que anteriormente se realizaban de manera manual. Actualmente, los establecimientos de alojamiento utilizan herramientas tecnológicas para gestionar reservas, controlar la ocupación, administrar huéspedes y facilitar la operación diaria del hotel. En este contexto, el software hotelero se convierte en una herramienta fundamental para optimizar la organización de la información y mejorar la calidad del servicio prestado al cliente.
  
    .row.align-items-center.mb-5
      .col-lg-auto.d-none.d-lg-block
        img(src="@/assets/curso/tema1/img02.svg").mx-auto
      .col-lg
        p.mb-0 El uso de sistemas informáticos en hotelería no solo facilita el control operativo, sino que también permite integrar diferentes áreas del establecimiento, como reservas, recepción, housekeeping, facturación y comercialización digital. Según Kasavana y Cahill (2017), los sistemas de gestión hotelera contribuyen a mejorar la productividad, reducir errores operativos y fortalecer la toma de decisiones dentro de la organización.

    separador
    
    #t_1_1.titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 1.1 Concepto de software hotelero
    ...
    .row.mb-5.justify-content-center.align-items-center
      ...
      .col-lg-9
        p.mb-3(data-aos="fade-right") El software hotelero es un sistema informático diseñado para apoyar y automatizar los procesos operativos, administrativos y comerciales de los establecimientos de alojamiento. Estas herramientas permiten centralizar la información relacionada con reservas, huéspedes, disponibilidad de habitaciones, tarifas, pagos y reportes, facilitando una gestión más organizada y eficiente.
        
        .bg-fondo-2.px-lg-5.py-lg-4.px-4.py-3.br-15.mb-3
          p.mb-0 En hotelería, el software más utilizado es el PMS (Property Management System), el cual funciona como una plataforma central desde donde se administra gran parte de la operación del hotel. Este sistema permite registrar reservas, realizar check-in y check-out, controlar la ocupación y generar reportes operativos en tiempo real.

        p.mb-0 El crecimiento del turismo y la necesidad de agilizar los procesos de atención al cliente impulsaron la implementación de sistemas tecnológicos en los hoteles. Actualmente, incluso pequeños establecimientos utilizan software especializado para optimizar sus operaciones y mejorar la experiencia del huésped.
      ...
      .col-lg-12
        SlyderF(columnas="col-lg-4 col-xl-4 col-md-12 col-sm-12")
          ...
          .tarjeta.bg-fondo-3.p-4.h-100
            .row.justify-content-center.mb-3
              .col-8
                img(src='@/assets/curso/tema1/img08.svg' alt='Imagen de integración', style="width: 100px;").mx-auto
            h4.text-center #[b Integración] 
            p.text-center Se conecta con otros sistemas del hotel y canales de venta (OTA, Channel Manager, etc.).
    ...
    #t_1_3.titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 1.3 Tipos de software utilizados en hotelería

    .row.align-items-center.mb-5
      .col-lg-auto.d-none.d-lg-block
        img(src="@/assets/curso/tema1/img17.svg").mx-auto
      .col-lg
        p.mb-3 Los establecimientos hoteleros utilizan diferentes tipos de software según las necesidades operativas y el tamaño del negocio. Algunos sistemas están enfocados en la gestión integral de la operación, mientras que otros apoyan procesos específicos como reservas, comercialización o relación con clientes.
        p.mb-0 Entre los principales tipos de software utilizados en hotelería se encuentran:
        ...
        SlyderA(tipo="b").bg-color-white.p-0.p-lg-4.tarjeta
          .row.justify-content-center.align-items-center.p-4.p-lg-3
            .col-lg-7.mb-4.mb-lg-0.mb-3.mb-lg-0
              h4.mb-3 PMS (Property Management System)
          ...
          .row.justify-content-center.align-items-center.p-4.p-lg-3
            .col-lg-7.mb-4.mb-lg-0.mb-3.mb-lg-0
              h4.mb-3 CRS (Central Reservation System)
          ...
          .row.justify-content-center.align-items-center.p-4.p-lg-3
            .col-lg-7.mb-4.mb-lg-0.mb-3.mb-lg-0
              ...
              p.mb-0 Software utilizado para administrar la relación con los clientes y gestionar estrategias de fidelización.
            .col-md-8.col-lg-5
              figure
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-12.mb-4
        p.mb-0 A continuación, se presenta una tabla comparativa de los diferentes softwares hoteleros:

      .col-12.col-lg-12
        .titulo-sexto.color-acento-contenido.mb-4
          h5 
            b Tabla 1.
          span Cuadro comparativo de software hotelero
          ...
          table
            ...
            tbody
              tr
                ...
                td Reservas, check-in/check-out, habitaciones, facturación.
              tr
                td CRS (Central Reservation System)
                td Centralización de reservas
                td Reservas desde web, agencias y call center.
              tr
                td Channel Manager
      ...
      .container(data-aos="fade-right")
        .tarjeta.tarjeta--blanca.row.justify-content-center.align-items-center.mb-0.p-4
          .col-lg-9.order-2.order-lg-1
            ...
            p.mb-0 Un hotel utiliza un PMS conectado a un Channel Manager y a diferentes OTA. Cuando un huésped realiza una reserva desde Booking, el sistema actualiza automáticamente la disponibilidad en todas las plataformas, evitando sobreventas y facilitando el control de ocupación.
    ...
    .row.align-items-center.mb-5
      ...
      .col-lg
        p.mb-3 El PMS constituye el núcleo operativo del software hotelero, ya que centraliza la información y permite coordinar las diferentes áreas del establecimiento. Este sistema facilita la automatización de tareas y mejora la eficiencia en la prestación del servicio.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-12.col-lg-12
        .titulo-sexto.color-acento-contenido.mb-4
          h5 
            b Tabla 2.
          span Ventajas y desafíos del software hotelero
        .tabla-a.color-acento-contenido 
          table
            caption <span style="font-weight: normal">Nota. SENA, (2026).</span>
            thead
              tr
                th Aspecto
                th Ventajas del software hotelero
            ...
            tbody
              ...
              tr
                ...
                td Conecta departamentos como recepción, housekeeping, facturación y reservas.
              ...
              tr
                ...
                td Facilita la conexión con OTA, motores de reserva y Channel Manager.
              ...
              tr
                ...
                td Agiliza procesos de check-in, facturación y atención personalizada.
              ...
              tr
                ...
                td Facilita el control tarifario y la implementación de estrategias de revenue management.
    ...
    .row.align-items-center.justify-content-center.mb-3
      .col-lg-10
        .cajon.bg-color-23.p-4
          p.mb-0 Este caso evidencia cómo el uso del software hotelero contribuye a optimizar los procesos operativos, fortalecer la comunicación entre áreas y aumentar la eficiencia administrativa dentro de los establecimientos de alojamiento.
